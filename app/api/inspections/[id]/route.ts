...
const mockProperties = [
  {
    _id: "prop1",
    location: { state: "NY", localGovernment: "Manhattan", area: "Downtown" },
    landSize: { measurementType: "sqft", size: 1200 },
    additionalFeatures: {
      additionalFeatures: [],
      noOfBedrooms: 2,
      noOfBathrooms: 2,
    },
    features: ["Modern", "City View"],
    tenantCriteria: [],
    areYouTheOwner: true,
    isAvailable: "yes",
    pictures: [
  ...
  {
    _id: "prop2",
    location: { state: "NY", localGovernment: "Queens", area: "Suburbia" },
    landSize: { measurementType: "sqft", size: 2500 },
    additionalFeatures: {
      additionalFeatures: [],
      noOfBedrooms: 4,
      noOfBathrooms: 3,
    },
    features: ["Spacious", "Backyard"],
    tenantCriteria: [],
    areYouTheOwner: true,
    isAvailable: "yes",
    pictures: [
  ...
  {
    _id: "prop3",
    location: { state: "NY", localGovernment: "Manhattan", area: "Uptown" },
    landSize: { measurementType: "sqft", size: 2000 },
    additionalFeatures: {
      additionalFeatures: [],
      noOfBedrooms: 3,
      noOfBathrooms: 3,
    },
    features: ["Luxury", "Panoramic View"],
    tenantCriteria: [],
    areYouTheOwner: true,
    isAvailable: "yes",
    pictures: [
